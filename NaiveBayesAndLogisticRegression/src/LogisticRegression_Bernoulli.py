...
def main():
    ...
    for i in lambdas_list:
        ...
        A, P, R, F1 = get_metrics(valid_data, partial_weights, labels_valid)
        if A > UA or A == UA:
            lambda_final = i
            UA = A
    ...
    print("Metrics for Bernoulli Model - LogisticRegression -", dataset_name)
