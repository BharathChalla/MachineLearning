...
params_k_means = {
    ...
    'comp_img_save_paths': ["output/part2/images/Koala", "output/part2/images/Penguins"],
    ...
    if len(arg_list) != 4:
        ...
        for orig_img_path, save_path in zip(orig_img_paths, comp_img_save_paths):
            ...
            for k, seed in get_param_values(params_k_means):
                ...
                k_means_jpg = get_k_means_compressed_img(orig_img_path, k, seed)
                comp_img_path = save_path + '-K' + str(k).zfill(2) + '-S' + str(seed).zfill(10) + '.jpg'
                ...
                print("Compressed image Size:", round(compressed_img_size, 3), "KB ", "Run time:", run_time, "s")
